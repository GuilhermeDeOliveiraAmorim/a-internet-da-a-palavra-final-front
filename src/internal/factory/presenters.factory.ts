...
import { GetAvailableMonthsYearsUseCase } from "../presenters/displays_list_questions";
import { GetCategoryTagsTotalsByMonthYearUseCase } from "../presenters/show_result_question";
...
export class PresentersFactory {
  ...
  getAvailableMonthsYearsUseCase() {
    return new GetAvailableMonthsYearsUseCase(this.presentersGateway);
  }
}
